...
const float CUTOFF_FREQUENCY = 20.0; // Frecuencia de corte en Hz. ¡AJUSTA ESTE VALOR! 5-15 Hz suele ser un buen rango.
...
void handleConcentricState(float linear_az, float dt) {
    ...
    Serial.print("V_realtime: ");
    Serial.print(velocity, 4); // Imprime la velocidad en tiempo real con 4 decimales
    Serial.print(" | EndCounter: ");
    Serial.println(concentric_end_counter);
